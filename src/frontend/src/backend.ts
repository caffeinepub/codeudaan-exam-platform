...
export class Backend implements backendInterface {
    ...
    async getAllResults(): Promise<Array<ExamResult>> {
    ...
    async getExamResult(arg0: string): Promise<ExamResult> {
        if (this.processError) {
            try {
    ...
    async submitResult(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitResult(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
